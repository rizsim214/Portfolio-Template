        ...
        <div>
          <form @submit.prevent="handleSubmit" class="bg-white/5 border border-white/10 rounded-lg p-8 space-y-6">
            ...
            <button type="submit" :disabled="isSubmitting"
              class="w-full bg-linear-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-3 rounded-lg transition-all duration-200 transform hover:scale-105">
